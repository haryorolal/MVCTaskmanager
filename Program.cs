...
//to enable routerLogger to work byt setting options.allowsynchronouIO to true
builder.Services.Configure<IISServerOptions>(options =>
  {
   ...
   //get database connection name from the connectionstrings in appsetting json file
builder.Services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer
(builder.Configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly("MVCTaskmanager")));
